<?php 
    ...
    session_start();
            if (isset($_SESSION['sesion_iniciada_ad'])) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                       <!-- <div class="alert alert-info alert-dismissable">
                        ...
                        <h4 style="color:#084D87" ><strong> Noticias</strong></h4>
                    <ul id="galeria">
                        <li><a href="http://www.google.cl" > <img  src="img/img1.jpg" alt="#" title="#" /></a> </li>

                                <li><a href="http://www.google.cl" ><img src="img/img2.jpg" alt="#" title="#" /></a></li>
                                <li><a href="http://www.google.cl" ><img src="img/img3.jpg" alt="#" title="#" /></a></li>
                                <li><a href="http://www.google.cl" ><img src="img/img4.jpg" alt="#" title="#" /></a></li>
                                <li><a href="http://www.google.cl" ><img src="img/img5.jpg" alt="#" title="#" /></a></li>
                                    <li><a href="http://www.google.cl" ><img src="img/img6.jpg" alt="#" title="#" /></a></li>
                                    <li><a href="http://www.google.cl" ><img src="img/img7.jpg" alt="#" title="#" /></a></li>
...
<?php
            ...
            $aviso = "No has iniciado sesion de ADMINISTRADOR";
            echo "<script>";
            echo "alert('$aviso');";
