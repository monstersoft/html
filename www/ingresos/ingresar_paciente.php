            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="ingreso_paciente.php" method="post">

                             <div class="form-group">
                                <label>Nombre (*):</label>
                                <input class="form-control" placeholder="Ingrese Nombre del Paciente" name="nombre" maxlength="15">
                                <p class="help-block"></p>
                            </div>
                            
                            <div class="form-group">
                                <label>Apellido Paterno (*):</label>
                                <input class="form-control" placeholder="Ingrese Apellido Paterno del Paciente" name="ap_paterno" maxlength="15">
                                <p class="help-block"></p>
                            </div>
                            
                            <div class="form-group">
                                <label>Apellido Materno (*):</label>
                                <input class="form-control" placeholder="Ingrese Apellido Materno del Paciente" name="ap_materno" maxlength="15">
                            </div>
                            
                            <div class="form-group">
                                <label>RUT (*):</label>
                                <input class="form-control" name="rut" type="text" onkeypress="return solonumeros(event)" placeholder="Ingrese RUT sin guion, ejemplo: 157620989" alt="Si el rut termina en K reemplazar por 0" maxlength="10">
                                <p class="help-block"></p>
                            </div>
                            
                            <div class="form-group">
                                <label>Edad (*):</label>
                                <input class="form-control" name="edad" type="number" onkeypress="return solonumeros(event)" maxlength="3" max="110">
                                <p class="help-block"></p>
                            </div>
                            <div class="form-group">
                                <label>Patologia que padece (*):</label>
                            ...
                            <div class="form-group">
                                <label>Gravedad de la enfermedad (*):</label>
                                <select class="form-control" name="grado_atencion" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="tel" placeholder="Ingrese Telefono del Paciente" name="fono">
                            </div>
                            
                            <div class="form-group">
                                <label>Correo Electronico e-mail(*):</label>
                                <input class="form-control" type="email" placeholder="Ingrese Correo Electronico del Paciente" name="email">
                            </div>
                            <div class="form-group">
                                <label>Prevision(*):</label><br>
                                <input type="radio" name="prevision" value="fonasa">Fonasa
                                <input type="radio" name="prevision" value="isapre">Isapre
                                <input type="radio" name="prevision" value="sin prevision">Sin Prevision
                                </div>
                               ...
                               <div class="form-group">
                                ...
                                <p class="help-block">Ingrese Calle</p>
                            </div><div class="form-group">
                                <label>Numero:</label>
                                <input onkeypress="return solonumeros(event)" class="form-control" type="text" name="numero">
                                <p class="help-block">Ingrese Numero de la Casa o Departamento</p>
                            </div><div class="form-group">
                                <label>Comuna:</label>
                                <input class="form-control" type="text" name="comuna">
                                <p class="help-block">Ingrese Comuna en que vive el Paciente</p>
                            </div>

                            <input type="submit" class="btn btn-default" value="Guardar" style="background:#084D87;color:white" name="guardar">
                            <button type="reset" class="btn btn-default">Borrar Campos</button>
                            <button type="button" class="btn btn-default"><a href="../index_funcionario.html">Cancelar</a></button>
