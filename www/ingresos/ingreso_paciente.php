...
<?php 
    ...
    include ("genera_pass.php");
        ...
        $grado=$_POST['grado_atencion'];
        $id_patologia=$_POST['id_patologia'];
        $pass = generador(10);


        $saca=("SELECT * FROM paciente WHERE rut='".$rut."'");
        ...
        if ($cuenta != 0) {
            ...
            $accion="INSERT INTO paciente (rut, nombre, ap_paterno, ap_materno, calle, numero, comuna, fono, email, pass, edad, prevision) 
            VALUES ('".$rut."','".$nombre."','".$ap_paterno."','".$ap_materno."','".$calle."','".$numero."','".$comuna."', $telefono,'".$correo."','".$pass."',$edad, '".$prevision."')";
            //$pat_pac="INSERT INTO patologia_paciente (rut_paciente, id_patologia) VALUES ('".$rut."','".$id_patologia."', '".$grado."' )";
            //$cm_pac="INSERT INTO cm_paciente ('".$rut."','".$id_centro."')";
            $s1=pg_query($conexion, $accion);
		        ...
		        ?>
		            <div class="col-lg-12">
		                ...
		                Paciente Ingresado con exito</h3>                        
		            </div> 
                    <div class="col-lg-12" style="border:solid 2px skyblue">
                    <table>
                        <tr><td>
            ...
            <?php
                ...
                echo"error al ingresar el Paciente";
            }
    	}
    }
