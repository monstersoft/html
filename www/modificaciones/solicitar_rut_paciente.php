                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="modificar_paciente.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rut_paciente" required maxlength="10" min="1000000">
                                <p class="help-block">Ingrese RUT del Paciente</p>
                            </div>
                            
                            <input type="submit" class="btn btn-default" name="buscar" style="background:#084D87;color:white" value="Modificar">
