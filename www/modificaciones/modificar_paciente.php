<?php 
    ...
    include ("conexion.php");
        ...
        $ver="SELECT rut FROM paciente WHERE rut='".$rut."'";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Modificar Paciente <em><?php echo "$muestra[nombre] $muestra[ap_paterno] $muestra[ap_materno]" ; ?></em>
                        </h1>                        
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="modificar_paciente.php" method="POST">
                            
                            <div class="form-group">
                                <h4 class="page-header">Cambiar Telefono:</h4>
                                <input class="form-control" required name="telefono" type="text" placeholder="Ingres nuevo numero telefónico" maxlength="12">
                                <input type="hidden" name="rut_paciente" value="<?php echo "$rut"; ?>">
                                <p class="help-block">Telefono actual: <em><?php echo "$muestra[fono]"; ?></em></p>
                        ...
                        <?php 
                            ...
                            if(isset($_POST['cambiar_fono'])){
                                ...
                                $accion=" UPDATE paciente SET fono=$telefono WHERE rut='".$rut."'";
                                $ejecuta=pg_query($conexion, $accion);
                                if ($ejecuta) {

                                    $ver2="SELECT * FROM paciente WHERE rut='".$rut."'";
                        ...
                        <form role="form" action="modificar_paciente.php" method="POST">                            
                            <div class="form-group">
                                ...
                                <input class="form-control" required name="correo" type="text" placeholder="Ingrese nuevo e-mail" maxlength="50">
                                <input type="hidden" name="rut_paciente" value="<?php echo "$rut"; ?>">
                                <p class="help-block">Correo actual: <em><?php echo "$muestra[email]"; ?></em> </p>
                        ...
                        <?php 
                            ...
                            if(isset($_POST['cambiar_email'])){
                                ...
                                $accion=" UPDATE paciente SET email='".$correo."' WHERE rut='".$rut."'";
                                $ejecuta=pg_query($conexion, $accion);
                                if ($ejecuta) {

                                    $ver2="SELECT email FROM paciente WHERE rut='".$rut."'";
                                    $mostrar=pg_fetch_array(pg_query($conexion, $ver2));
                        ...
                        <?php 
                            ...
                            if(isset($_POST['cambiar_direccion'])){
                                ...
                                $accion=" UPDATE paciente SET calle='".$calle."', numero=$numero, comuna='".$comuna."' WHERE rut='".$rut."'";
                                $ejecuta=pg_query($conexion, $accion);
                                if ($ejecuta){
...
header("location:solicitar_rut_paciente.php");
}
