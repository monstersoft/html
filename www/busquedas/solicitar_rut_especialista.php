                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul id="demo3" class="collapse">
                            <li>
                                <a href="mostrar_atencion.php">Atencion</a>
                            </li>
                            <li>
                                <a href="mostrar_paciente.php">Paciente</a>
                            </li>
                            <li>
                                <a href="mostrar_especialista.php">Especialista</a>
                            </li>
                        </ul>
                    </li>
                  </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="mostrar_especialista.php" method="POST">
                        
                            <div class="form-group">
                                <label>RUT Paciente</label>
                                <input class="form-control" type="text" name="rut" onkeypress="return solonumeros(event)" required maxlength="10" min="1000000">
                                <p class="help-block">Ingrese RUT del Paciente</p>
                            </div>                            
                        ...
                        <div class="form-group">
                                <br><br>
                                <label>Mostrar Todos Los Espesicalistas Registrados: <br></label>
