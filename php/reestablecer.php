<?php
    ...
    $arr['mensaje'] = $correo;
    enviarMailReestablecerContraseña('Nombre Usuario',$correo,'http://localhost/html/reestablecer.php');
    echo json_encode($arr);

    function enviarMailReestablecerContraseña($nombreSupervisor,$emailSupervisor,$link) {
			$e = new PHPMailer;
			$e->Host = 'localhost';
