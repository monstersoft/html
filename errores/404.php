...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://www.mmonitors.com/recursos/awesome/css/font-awesome.min.css">
    ...
    <body>
        <div class="ui aligned center aligned grid">
            <div class="margen column">
                ...
                <h4 class="montserrat cent">Page not found</h4>
            </div>
        </div>
        <script src="http://www.mmonitors.com/recursos/jquery/jquery.min.js"></script>
        <script src="http://www.mmonitors.com/recursos/semantic/semantic.min.js"></script>
    </body>
</html>