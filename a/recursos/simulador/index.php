            ...
            $.ajax({
                ...
                success: function(arreglo) {
                    $.each(arreglo,function(index){
                        $('#zonas').append('<option value="'+arreglo[index].idZona+'">'+arreglo[index].nombre+'</option>');
                    });
                },
