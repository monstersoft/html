            ...
            <div class="ui grid">
                ...
                <div class="ui sixteen wide mobile sixteen wide tablet  eight wide computer column">
                    <div class="ui fluid card">
                        <div class="content">
                            ...
                            <div class="header">Accordion - FLuid</div>
                ...
                <div class="ui sixteen wide mobile sixteen wide tablet  eight wide computer column">
                    <div class="ui fluid card">
                        <div class="content">
                            <i class="industry icon right floated"></i>
                            <div class="header">Basic tabs</div>
                            <div class="ui divider"></div>
                            <div class="description">
                            ...
                            <div class="ui bottom attached tab segment active" data-tab="first">
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum dignissimos odit obcaecati ut aliquam velit similique? Soluta obcaecati rerum, non dolorum, itaque facilis vitae velit recusandae cupiditate vel necessitatibus numquam!
                            </div>
                            <div class="ui bottom attached tab segment" data-tab="second">
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis excepturi inventore aliquid asperiores nihil quidem dolores ex facere repellat. Consequatur, dolorem, velit at dolores ipsa recusandae sapiente eius placeat aperiam?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam voluptates doloribus animi debitis esse a quas culpa reiciendis, consequuntur facere sint itaque! Quia enim voluptatem, vel cupiditate numquam fuga vero!
                            </div>
                            <div class="ui bottom attached tab segment" data-tab="third">
                              <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit accusantium, sit. Doloribus rem ab obcaecati totam quaerat ex nostrum. Odit eaque, quas. Placeat tenetur assumenda, accusamus magni in molestiae, ipsa.</div>
                              <div>Facilis asperiores necessitatibus ea fugiat nisi! Vero odio debitis ducimus, quas labore neque, a magni, inventore sit qui, iste ea! Incidunt distinctio, atque reprehenderit nostrum quas fugit maxime dolore praesentium.</div>
                              <div>Recusandae praesentium facilis laboriosam consequuntur, ea laudantium quas explicabo quisquam in aliquam natus, alias expedita id nam ducimus iusto, magnam. Odit pariatur neque, at, eaque quia tenetur veritatis totam consequuntur.</div>
                            </div>
                            </div>
                        </div>
                        <a class="ui bottom attached button insertar" href="#"><i class="plus icon"></i></a>
                ...
                <div class="ui sixteen wide mobile sixteen wide tablet  eight wide computer column">
                    <div class="ui fluid card">
                        <div class="content">
                            <i class="industry icon right floated"></i>
                            <div class="header">A standard table</div>
                            <div class="ui divider"></div>
                            <div class="description">
