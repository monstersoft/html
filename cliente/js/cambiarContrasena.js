...
$('body').on('click','#btnVolverCambiarContraseña',function() {
    ...
    $('.alert').remove();
    $(this).removeClass('btn-success').addClass('btn-default').html('<i class="cargar fa fa-refresh"></i> Cambiar').attr('id','btnCambiarContraseña');
});
        ...
        $.ajax({                  
            ...
            success: function(arreglo) {
                if(arreglo.exito == true) {
                    ...
                    $('#btnCambiarContraseña').removeClass('btn-default').addClass('btn-success').html('<i class="cargar fa fa-repeat"></i>  Volver a cambiar').attr('id','btnVolverCambiarContraseña');
                }
                else
